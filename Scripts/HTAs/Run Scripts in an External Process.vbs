Demonstrates how to use an environment variable, formatted like the PATH variable to include VBScript code, and then execute scripts in an external process , all without having to have a fixed location for the VBScript code. This makes central storage of scripts (repository-style) possible. 
