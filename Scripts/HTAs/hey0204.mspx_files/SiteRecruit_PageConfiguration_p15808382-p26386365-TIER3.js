...
SiteRecruit_Config.frequency = 0.004;
...
// Iterate through the survey configurations.
        ...
        SiteRecruit_Config.invitations[0].acceptParams = 'l=9&site=53';
        SiteRecruit_Config.invitations[0].viewParams = 'log=comscore/view/p15808382-view.log&site=53';
        SiteRecruit_Config.invitations[0].invitationContent = ' <table width="360" cellpadding="3" cellspacing="0" border="0" bgcolor="#FFFFFF"><tr><td> <table width="100%" cellpadding="1" cellspacing="0" border="0" bgcolor="#999999"><tr><td> <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF"><tr valign="top"><td> <img src="/library/svy/technet_logo.gif" /><a href="Close" onclick="@declineHandler"><img border="0" src="/library/svy/msdn-close.gif" /></a><br /> <img src="/library/svy/top-stripe.gif" /> <table width="100%" cellpadding="5"><tr><td>  <div style="font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 11px; color: #000000; margin: 0 0 15px 0;">Microsoft is conducting an online survey to understand your opinion of the TechNet Web site.  If you choose to participate, the online survey will be presented to you when you leave the TechNet Web site. <br /><br /> Would you like to participate?  </div>  <div align="center" style="margin: 0; padding: 0"> <input style="margin: 0; padding: 0" type="button" value="  Yes  " onclick="@acceptHandler" />&nbsp;&nbsp; <input style="margin: 0; padding: 0"  type="button" value=" No " onclick="@declineHandler" /> </div>  <div style="font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 11px; color: #000000; margin: 15px 0 2px 0;"><a style="color:#0000EE; text-decoration: underline; " href="http://survey.surveysite.com/wi/p15808382/privacy_p15808382_53.html" target="_blank">Privacy Statement</a></div>  </td></tr></table> <img src="/library/svy/bottom-stripe.gif" /></td></tr></table> </td></tr></table> </td></tr></table>   '; 
        ...
        SiteRecruit_Config.invitations[0].autoCentering = true;
                    ...
                    SiteRecruit_Config.invitations[0].trackerUrl = '/library/svy/SiteRecruit_Tracker_p15808382mt-technet.htm';
