...
function mnpdtOpen(id)
{
	...
	mnpdtXml[id].load(appRoot + "mnp_utility.mspx/framesmenudata?shell=" + shell + "&guid=" + guid);
...
function synctoc()
{
	...
	try
	{
		if (top.MNPMenuFrame.document.readyState != "complete")
		{
	...
	xml.load(appRoot + "mnp_utility.mspx/framesmenusync?url=" + escape(me) + "&lookup=" + escape(url));
