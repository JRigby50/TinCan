...
arrTest = Modem(strServer)

Function Modem(strComputer)
' Retrieves information about all the modems installed in a computer
Dim objWMIService, colItems, objItem, objElement, arrModem(33,0)
...
For Each objItem in colItems
    ...
    Wscript.Echo "Maximum Baud Rate To SerialPort: " & objItem.MaxBaudRateToSerialPort
