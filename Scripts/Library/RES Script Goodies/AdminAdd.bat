...
REM Modified by Jim Rigby for East Metro Sites
REM Last Modified: 10-31-2003
...
:GROUP_WRK2
REM Checking for Local OU Admin Group - Adding if missing!
net localgroup Administrators | find /i "%USERDOMAIN%\INFO GG Eastern Region Admins" > nul
...
CLS
:ADDGROUP2
net localgroup Administrators "%USERDOMAIN%\INFO GG Eastern Region Admins" /ADD > nul
