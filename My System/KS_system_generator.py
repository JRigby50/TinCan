...
def human_readable_star_name():
    ...
    adjectives = ["Bright", "Distant", "Shining", "Glowing",
                  "Mystic", "Ancient", "Celestial", "Radiant", "Silent", "Lonely"]
    nouns = ["Giant", "Dwarf", "Beacon", "Nova", "Star", "Light",
             "Phoenix", "Guardian", "Voyager", "Sentinel"]
...
def generate_star_data_table(num_rows=100):
    ...
    columns = ["Discord Name", "Star Name", "Star Kelvin",
               "Sector", "Gal X", "Gal Y", "Gal Z", "Description"]
